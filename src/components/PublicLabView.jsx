                                            ...
                                            <td colSpan={6} style={{ padding: '0 24px 24px 24px' }}>
                                                <div style={{ background: '#fff', border: '1px solid #E2E8F0', borderRadius: '8px', padding: '16px', display: 'flex', gap: '24px', flexWrap: 'wrap' }}>
                                                    <div style={{ flex: '1', minWidth: '250px' }}>
                                                        ...
                                                        <div style={{ fontSize: '0.85rem', color: '#334155', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                                                            {r.biopsia_congelacion ? <div><span style={{ background: '#E0F2FE', color: '#0369A1', padding: '2px 6px', borderRadius: '4px', fontWeight: 600, fontSize: '0.75rem', marginRight: '6px', border: '1px solid #BAE6FD' }}>❄️ Congelación</span> <span style={{marginLeft: '4px', fontSize: '0.85rem'}}><strong style={{color: '#475569'}}>Cant:</strong> {r.biopsia_congelacion}</span></div> : null}
                                                            
                                                            {r.biopsia_simple ? <div><span style={{ background: '#DCFCE7', color: '#15803D', padding: '2px 6px', borderRadius: '4px', fontWeight: 600, fontSize: '0.75rem', marginRight: '6px', border: '1px solid #BBF7D0' }}>Simple</span> <span style={{marginLeft: '4px', fontSize: '0.85rem'}}><strong style={{color: '#475569'}}>Cant:</strong> {r.biopsia_simple}</span> <div style={{ color: '#64748B', marginLeft: '12px', marginTop: '4px', fontSize: '0.8rem', display: 'flex', gap: '4px' }}><span style={{color: '#CBD5E1'}}>↳</span> <span style={{fontStyle: 'italic'}}>{r.material_biopsia_simple || 'Material no especificado'}</span></div></div> : null}
                                                            
                                                            {r.biopsia_ampliada ? <div><span style={{ background: '#FFEDD5', color: '#C2410C', padding: '2px 6px', borderRadius: '4px', fontWeight: 600, fontSize: '0.75rem', marginRight: '6px', border: '1px solid #FED7AA' }}>Ampliada</span> <span style={{marginLeft: '4px', fontSize: '0.85rem'}}><strong style={{color: '#475569'}}>Cant:</strong> {r.biopsia_ampliada}</span> <div style={{ color: '#64748B', marginLeft: '12px', marginTop: '4px', fontSize: '0.8rem', display: 'flex', gap: '4px' }}><span style={{color: '#CBD5E1'}}>↳</span> <span style={{fontStyle: 'italic'}}>{r.material_biopsia_ampliada || 'Material no especificado'}</span></div></div> : null}
                                                            
                                                            {!r.biopsia_congelacion && !r.biopsia_simple && !r.biopsia_ampliada && <span style={{ color: '#94A3B8' }}>Sin muestras registradas.</span>}
                                                        </div>
                                                    </div>
