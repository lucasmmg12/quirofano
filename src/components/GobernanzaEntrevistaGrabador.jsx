...
export default function GobernanzaEntrevistaGrabador({ currentUser, proyectoId, onBack }) {
    ...
    const openHistoryItem = async (item) => {
        ...
        setSelectedPlantilla({ 
            ...
            nombre: item.gobernanza_plantillas?.nombre || 'Auditoría Pasada',
            preguntas: item.gobernanza_plantillas?.preguntas || []
        });
